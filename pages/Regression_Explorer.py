...
with tab1:
    ...
    feature_display = st.multiselect(
        ...
        default=["Competition Day", "Travel Day", "Sleep Hours"]
    )
...
with tab2:
    ...
    predict_feature_display = st.multiselect(
        ...
        default=["Nutrition Quality", "Competition Day", "Sleep Hours"]
    )
    ...
    for f in predict_features:
        if f in df.columns:
            ...
            if f == "Protein Type Night Prior":
                protein = st.radio("Protein Type Night Prior", ("Chicken", "Beef", "Pork", "Salmon", "Other"))
                prior_protein_map = {
                    "Beef": "Beef_lag",
                    "Chicken": "Chicken_lag",
                    "Pork": "Pork_lag",
